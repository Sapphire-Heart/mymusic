document.addEventListener('readystatechange',function(){
	if(document.readyState === 'complete'){
		...
		var musics = [
			{name:'墨写你的美',src:'冷漠 - 墨写你的美.mp3',singer:'冷漠',duration:'3:50'},
			{name:'一首情歌',src:'任重 - 一首情歌.mp3',singer:'任重',duration:'4:30'},
			{name:'边做边爱',src:'陈旭、段玫梅 - 边做边爱.mp3',singer:'陈旭、段玫梅',duration:'4:35'},
			{name:'男人好难',src:'沙宝亮、黄渤 - 男人好难.mp3',singer:'沙宝亮、黄渤',duration:'4:57'},
			{name:'Oh My Love',src:'宋孟君、迟漠寒 - Oh My Love.mp3',singer:'宋孟君、迟漠寒',duration:'3:31'},
			{name:'最爱的人伤我最深',src:'张惠妹 - 最爱的人伤我最深.mp3',singer:'张惠妹',duration:'4:58'},
			{name:'夜色',src:'艺涛、梁剑东 - 夜色.mp3',singer:'艺涛、梁剑东 ',duration:'3:07'},
			{name:'不变的音乐',src:'王绎龙 - 不变的音乐.mp3',singer:'王绎龙',duration:'4:22'},
			{name:'爱一点',src:'王力宏、章子怡 - 爱一点.mp3',singer:'王力宏、章子怡',duration:'5:06'}
		];
